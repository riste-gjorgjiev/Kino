...
class TvControllerTest {
    ...
    void trending_withDefaultParams_callsServiceWithDayAndPage1() throws Exception {
        ...
        when(tvService.getTrendingTvShows("day", 1, new MediaFilterDto())).thenReturn(response);
        ...
        verify(tvService).getTrendingTvShows("day", 1, new MediaFilterDto());
    }
    ...
    void trending_withCustomParams_passesToService() throws Exception {
        ...
        when(tvService.getTrendingTvShows("week", 2, new MediaFilterDto())).thenReturn(response);
        ...
        verify(tvService).getTrendingTvShows("week", 2, new MediaFilterDto());
    }
    ...
    void popular_withDefaultPage_callsServiceWithPage1() throws Exception {
        ...
        when(tvService.getPopularTvShows(1, new MediaFilterDto())).thenReturn(response);

        mockMvc.perform(get("/api/tv/popular"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(1));

        verify(tvService).getPopularTvShows(1, new MediaFilterDto());
    }
    ...
    void popular_withCustomPage_passesToService() throws Exception {
        ...
        when(tvService.getPopularTvShows(3, new MediaFilterDto())).thenReturn(response);

        mockMvc.perform(get("/api/tv/popular").param("page", "3"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(3));

        verify(tvService).getPopularTvShows(3, new MediaFilterDto());
    }
    ...
    void topRated_withDefaultPage_callsServiceWithPage1() throws Exception {
        ...
        when(tvService.getTopRatedTvShows(1, new MediaFilterDto())).thenReturn(response);

        mockMvc.perform(get("/api/tv/top-rated"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(1));

        verify(tvService).getTopRatedTvShows(1, new MediaFilterDto());
    }
    ...
    void topRated_withCustomPage_passesToService() throws Exception {
        ...
        when(tvService.getTopRatedTvShows(2, new MediaFilterDto())).thenReturn(response);

        mockMvc.perform(get("/api/tv/top-rated").param("page", "2"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(2));

        verify(tvService).getTopRatedTvShows(2, new MediaFilterDto());
    }
    ...
    void onTheAir_withDefaultPage_callsServiceWithPage1() throws Exception {
        ...
        when(tvService.getAiringTvShows(1, new MediaFilterDto())).thenReturn(response);

        mockMvc.perform(get("/api/tv/on-the-air"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(1));

        verify(tvService).getAiringTvShows(1, new MediaFilterDto());
    }
    ...
    void onTheAir_withCustomPage_passesToService() throws Exception {
        ...
        when(tvService.getAiringTvShows(4, new MediaFilterDto())).thenReturn(response);

        mockMvc.perform(get("/api/tv/on-the-air").param("page", "4"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(4));

        verify(tvService).getAiringTvShows(4, new MediaFilterDto());
    }
