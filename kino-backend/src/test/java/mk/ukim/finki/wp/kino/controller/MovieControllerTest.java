...
class MovieControllerTest {
    ...
    void trending_withDefaultParams_callsServiceWithDayAndPage1() throws Exception {
        ...
        when(movieService.getTrendingMovies(eq("day"), eq(1), any(MediaFilterDto.class))).thenReturn(response);
        ...
        verify(movieService).getTrendingMovies(eq("day"), eq(1), any(MediaFilterDto.class));
    }
    ...
    void trending_withCustomParams_passesToService() throws Exception {
        ...
        when(movieService.getTrendingMovies(eq("week"), eq(2), any(MediaFilterDto.class))).thenReturn(response);
        ...
        verify(movieService).getTrendingMovies(eq("week"), eq(2), any(MediaFilterDto.class));
    }
    ...
    void popular_withDefaultPage_callsServiceWithPage1() throws Exception {
        ...
        when(movieService.getPopularMovies(eq(1), any(MediaFilterDto.class))).thenReturn(response);

        mockMvc.perform(get("/api/movies/popular"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(1));

        verify(movieService).getPopularMovies(eq(1), any(MediaFilterDto.class));
    }
    ...
    void popular_withCustomPage_passesToService() throws Exception {
        ...
        when(movieService.getPopularMovies(eq(3), any(MediaFilterDto.class))).thenReturn(response);

        mockMvc.perform(get("/api/movies/popular").param("page", "3"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(3));

        verify(movieService).getPopularMovies(eq(3), any(MediaFilterDto.class));
    }
    ...
    void topRated_withDefaultPage_callsServiceWithPage1() throws Exception {
        ...
        when(movieService.getTopRatedMovies(eq(1), any(MediaFilterDto.class))).thenReturn(response);

        mockMvc.perform(get("/api/movies/top-rated"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(1));

        verify(movieService).getTopRatedMovies(eq(1), any(MediaFilterDto.class));
    }
    ...
    void topRated_withCustomPage_passesToService() throws Exception {
        ...
        when(movieService.getTopRatedMovies(eq(2), any(MediaFilterDto.class))).thenReturn(response);

        mockMvc.perform(get("/api/movies/top-rated").param("page", "2"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(2));

        verify(movieService).getTopRatedMovies(eq(2), any(MediaFilterDto.class));
    }
    ...
    void upcoming_withDefaultPage_callsServiceWithPage1() throws Exception {
        ...
        when(movieService.getUpcomingMovies(eq(1), any(MediaFilterDto.class))).thenReturn(response);

        mockMvc.perform(get("/api/movies/upcoming"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(1));

        verify(movieService).getUpcomingMovies(eq(1), any(MediaFilterDto.class));
    }
    ...
    void upcoming_withCustomPage_passesToService() throws Exception {
        ...
        when(movieService.getUpcomingMovies(eq(4), any(MediaFilterDto.class))).thenReturn(response);

        mockMvc.perform(get("/api/movies/upcoming").param("page", "4"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.page").value(4));

        verify(movieService).getUpcomingMovies(eq(4), any(MediaFilterDto.class));
    }
